...
- Удалены возникавшие после FCC-записи UI-кнопки `Send CE Restore`,
  ...
  Auto FCC уведомления: остановка автоматического режима выполняется его же
  слайдером. CE-команда остаётся доступна диагностическому LAN API, но больше
  не занимает основное меню.
